...
import SpeakerPage, { Topic, Content } from '../../components/SpeakerPage'
...
export default () => (
  <SpeakerPage
    header={{
      ...
      subtitle: (
        <>
          Jared is a <bold> Maker of Awesomeness at Center Centre/UIE and</bold>{' '}
          Dana is the <bold> Co-Director of Center For Civic Design</bold>
        </>
      ),
    }}
    imagePath="/images/speakers/spk_JaredSpool&DanaChisnell.png"
    contents={{
      workshop: (
        <>
          <Topic>
